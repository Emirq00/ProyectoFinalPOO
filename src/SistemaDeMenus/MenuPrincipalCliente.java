...
public class MenuPrincipalCliente extends Menu{
        private static final CompraTicket CreacionTickets = null;
         ...
         */
        public static void menuUsuario(Cliente cliente){
    ...
    int opcion = 0;
        do {
            try {
                ...
                System.out.println("1. Comprar boletos y descargar boletos");
                ...
                switch (opcion) {
                    case 1:
                        ...
                        if (scanner.hasNextInt()) {
                            ...
                            Vuelo vueloSeleccionado = baseDeDatosVuelos.obtenerVuelo(numeroVuelo);
                            if (vueloSeleccionado != null) {
                                CompraTicket.comprarTicket(vueloSeleccionado, cliente);
                            } else {
                                System.out.println("Número de vuelo no encontrado.");
                            }
                        } else {
                            System.out.println("Entrada inválida, el número de vuelo debe ser un número entero.");
                            scanner.nextLine(); 
                        }
                        break;
