        ...
        do {
            try {
                ...
                switch (opcion) {
                    case 1:
                        // agregar vuelo
                        System.out.println("Función para agregar vuelo aún no implementada.");
                        break;
                    case 2:
                        // eliminar vuelo
                        System.out.println("Función para eliminar vuelo aún no implementada.");
                        break;
                    case 3:
    ...
    public static void gestionarUsuarios() {
        ...
        do {
            try {
                ...
                for (Usuario usuario : baseDeDatos.getBaseDeDatosUsuarios().values()) {
